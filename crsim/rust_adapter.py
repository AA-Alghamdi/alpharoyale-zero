...
# Mapping from Python CardType enum names to Rust engine card names
_CARD_TO_RUST: dict[CardType, str] = {
    CardType.KNIGHT: "Knight",
    CardType.ARCHERS: "Archer",
    ...
    CardType.MINIONS: "Minion",
    CardType.BABY_DRAGON: "BabyDragon",
    CardType.SKELETON_ARMY: "Skeleton",
    ...
    CardType.INFERNO_TOWER: "InfernoTower",
    CardType.TOMBSTONE: "Tombstone",
    CardType.ELIXIR_COLLECTOR: "ElixirCollector",
    ...
    CardType.FIRE_SPIRITS: "FireSpirits",
