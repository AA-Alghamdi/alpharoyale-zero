...
that are robust to simulator inaccuracies.
...
class DomainRandomizer:
    ...
    When a stable test opponent consistently exploits the policy, increase
    randomization strength until the exploit disappears, then keep training.
    """
